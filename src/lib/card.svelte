<script>
  ...
  <Card class="flex items-center bg-slate-800">
    <div class="w-10 h-10 flex items-center justify-center mr-4 bg-slate-800">
    ...
    <div>
      ...
      <a href="mailto:contact@omarammura.me">
        <p class="mb-3 font-normal text-gray-500 dark:text-gray-400">contact@omarammura.me</p>
      </a>
    </div>
  </Card>
